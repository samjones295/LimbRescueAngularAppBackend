...
public class AuthController {
    ...
    public void insertUser(String uuid, String username, String givenname, String middlename, String familyname) {
        ...
        String sql = "INSERT INTO " + table
                + " (uuid, username, givenname, middlename, familyname, confirmed, createdat, updatedat) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    @PostMapping("/signin")
    public void authenticateUser(@Valid @RequestBody LoginRequest loginRequest, HttpServletResponse response)
            throws Exception {
        ...
        CognitoJWT payload = cognitoMapper.readValue(CognitoJWTParser.getPayload(cognito_jwt).toString(),
                CognitoJWT.class);
        ...
        System.out.println("YOU:" + authTokenCookie.toString());
        response.addCookie(authTokenCookie);
    }

    @PostMapping("/signup")
    public void authenticateUser(@Valid @RequestBody SignupRequest signupRequest, HttpServletResponse response)
            throws Exception {
        ...
        Boolean success = cognitoHelper.SignUpUser(signupRequest.getUsername(), signupRequest.getPassword(),
                signupRequest.getGivenname(), "", signupRequest.getFamilyname());
        if (success) {
            this.insertUser(uuid, signupRequest.getUsername(), signupRequest.getGivenname(), "",
